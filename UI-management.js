...
export const herringActionTime = document.getElementById("herringactiontime");
...
export const codSpeed = document.getElementById("codspeed");
export const codVision = document.getElementById("codvision");
export const codActionTime = document.getElementById("codactiontime");
...
export const codBabyCost = document.getElementById("codbabycost");
...
function updateSelectionStats(object){
  ...
  selection.name = objects.protoFish[object.species].speciesName;
